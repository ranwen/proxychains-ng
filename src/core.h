...
typedef ssize_t (*recvfrom_t)(int __fd, void *__restrict __buf, size_t __n,
							  int __flags, struct sockaddr *__addr,
							  socklen_t *__restrict __addr_len);

typedef ssize_t (*recv_t)(int __fd, void *__buf, size_t __n, int __flags);

typedef int (*bind_t)(int __fd, const struct sockaddr *, socklen_t __len);

typedef int (*getsockname_t)(int __fd, struct sockaddr * __addr,
					   socklen_t *__restrict __len);
typedef int (*getpeername_t)(int __fd, struct sockaddr * __addr,
					   socklen_t *__restrict __len);

typedef int (*getsockopt_t) (int __fd, int __level, int __optname,
		       void *__restrict __optval,
		       socklen_t *__restrict __optlen) ;

typedef int (*setsockopt_t) (int __fd, int __level, int __optname,
		       const void *__optval, socklen_t __optlen) ;

typedef int (*listen_t) (int __fd, int __n);

typedef int (*accept_t) (int __fd, struct sockaddr * __addr,
		   socklen_t *__restrict __addr_len);
	
typedef int (*shutdown_t) (int __fd, int __how);

typedef ssize_t (*send_t) (int __fd, const void *__buf, size_t __n, int __flags);
